...
" syntax coloring; enable uses from theme, on overrides for defaults
syntax on
...
set nostartofline       " keep the cursor on the same horizontal location when scrolling text

" ASCII code in statusline
...
" Allow letter increase/decrease with Ctrl+a/Ctrl+x
" CAUTION: allowing this makes you unable to add only the numbers in the line
" set nrformats+=alpha
